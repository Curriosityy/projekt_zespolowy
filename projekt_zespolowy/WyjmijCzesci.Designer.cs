namespace projekt_zespolowy
{
	partial class WyjmijCzesci
	{
		...
		private void InitializeComponent()
		{
			...
			this.button1.Text = "Wyjmij czesci";
			...
			this.label3.Text = "Ilosc dostepnych czesci";
			// 
			// label4
			// 
			...
			// textBox2
			// 
			this.textBox2.Location = new System.Drawing.Point(199, 232);
			...
			this.Name = "WyjmijCzesci";
			this.Text = "WyjmijCzesci";
